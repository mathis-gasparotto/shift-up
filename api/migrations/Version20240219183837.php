 ...
 */
final class Version20240219183837 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE swot ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE swot DROP created_at, DROP updated_at');
