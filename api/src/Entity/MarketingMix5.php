...
#[ApiResource(
    ...
    operations: [
        ...
        new Post(
            uriTemplate: '/projects/{id}/marketing_mix_5s/last/download',
            requirements: [
                'id' => '^[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}$'
            ],
        ...
        new Post(
            uriTemplate: '/marketing_mix_5s/{id}/download',
            requirements: [
                'id' => '^[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}$'
            ],
...
class MarketingMix5 implements TracingAwareInterface, OwnerAwareInterface
{
    ...
    #[Groups(['marketing_mix_5:item:read'])]
