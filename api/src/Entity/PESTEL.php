...
#[ApiResource(
    ...
    operations: [
        ...
        new Post(
            uriTemplate: '/projects/{id}/pestels/last/download',
            requirements: [
                'id' => '^[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}$'
            ],
        ...
        new Post(
            uriTemplate: '/pestels/{id}/download',
            requirements: [
                'id' => '^[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}$'
            ],
...
class PESTEL implements TracingAwareInterface, OwnerAwareInterface
{
